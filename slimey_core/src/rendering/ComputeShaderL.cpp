...
ComputeShaderL::ComputeShaderL(const GLchar * computePath)
{
...
void ComputeShaderL::dispatch(GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z)
{
  glDispatchCompute(num_groups_x, num_groups_y, num_groups_z);
}

void ComputeShaderL::useShaderStorageBuffer(GLsizeiptr size, void * data)
{
